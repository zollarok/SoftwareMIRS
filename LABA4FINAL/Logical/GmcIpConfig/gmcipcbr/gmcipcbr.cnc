...
<Root LangModule="ailgcode" Version="1.0">
  ...
  <Constants>
    ...
    <ChampferLength type="STRING">CHF</ChampferLength>
    <ChampferWidth type="STRING">CHR</ChampferWidth>
  </Constants>
  <Preprocess>
  ...
  <GCodes>
    ...
    <G26 GNum="26" MinArgs="0" MaxArgs="1">
      <!--G26: Champfer-->
      <Arg Name="ChampferLength" ref="length" DataType="FLOAT" MinCount="0" MaxCount="1"/>
      <Arg Name="ChampferWidth" ref="width" DataType="FLOAT" MinCount="0" MaxCount="1"/>
      if Defined(:${length}:)
        #next_motion.Data.Champfer.Value = ${length};
        #next_motion.Data.Champfer.Mode = 1;
      elif Defined(:${width}:)
        #next_motion.Data.Champfer.Value = ${width};
        #next_motion.Data.Champfer.Mode = 2;
      else
        #next_motion.Data.Champfer.Mode = 0;
      endif
      #next_motion.Command = MPCMD_CHAMPFER;
      PushPacket(::);
    </G26>
